...
#### 深度挖掘标准
> - 身份证号：面1结果→拼出前6位(地区码)+8位(出生日期)+后4位→交叉验证全国身份证查询接口
> - 手机号：面2结果→WebSearch精确搜索11位→查关联账号→查泄露数据库→查TG关联
> - 住址：面2结果→关联企业→裁判文书→快递地址→社交签到→照片GPS→逐一对照
> - 社交账号：面6结果→逐平台用姓名/手机/邮箱三要素交叉搜索→查所有可能的马甲号
> - 行程/航班/住宿：社交媒体定位+签到+照片EXIF→推时间线→裁判文书的出庭/履约地点→交叉验证
> - 银行/征信/开房：搜索`"姓名"+"银行账号"` `"姓名"+"征信"` `"姓名"+"开房"` 关联拼图
