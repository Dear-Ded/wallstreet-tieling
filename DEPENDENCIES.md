...
|:-------|:-----|:------|:---------|:---------|
| **qcc-company** | 企查查 | 15个工具 | 工商登记、年报、股东、高管、对外投资、实控人 | WorkBuddy内置/市场安装 |
| **tyc-mcp** | 天眼查 | 162个工具 | 工商、司法、知识产权、经营、历史、董监高全维度 | WorkBuddy市场安装 |
...
| 连接器 | 平台 | 用途 | 安装方式 |
|:-------|:-----|:-----|:---------|
| **lingxi-financialsearch** | 国泰海通灵犀 | A股实时行情、F10财务数据、技术指标 | WorkBuddy市场安装 |
| **neodata-financial-search** | NeoData | 自然语言全品类金融数据查询 | WorkBuddy市场安装 |
| **futuapi** | 富途 OpenAPI | 港股/美股行情、期权链、K线、分时 | WorkBuddy市场安装 |
