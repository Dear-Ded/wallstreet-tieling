...
const TOOLS = [
  {
    ...
    description: 'One-click enterprise intelligence packet: one_click_readiness, report_exports, source-resilience recovery action, relationship graph auditability, quality gate, evidence graph, risk events, timeline, subject profile, monitoring delta.',
    inputSchema: {
      ...companyInputSchema,
  ...
  {
    name: 'due_diligence',
    description: 'Compatibility alias for investigate_company. Runs the executable risk-discovery graph pipeline and returns the same one_click_readiness, report_exports, and auditability fields.',
    inputSchema: {
      ...companyInputSchema,
      required: ['company_name']
    }
  ...
  },
  {
    ...
    description: 'Return desktop-agent release contract and remaining gates for Universal, Codex, Claude Code, Hermes, Doubao Office Task Mode, OpenClaude/open-source agents, and WorkBuddy.',
    inputSchema: {
      type: 'object',
      properties: {}
    }
