...
// 自实现MCP Server（基于@modelcontextprotocol/sdk）
// 双实现说明: deploy/mcp-server.json是外部依赖版（@anthropic/mcp-server-prompt）
// 本文件是自实现版。两版功能等价，选其一即可。
...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        depth: { type: 'string', enum: ['quick', 'standard', 'deep'], description: '快速/标准/深度', default: 'standard' },
  ...
  },
  {
    ...
    description: '人员背景调查：对指定人员进行全维度背景穿透，返回公开履历/任职/司法/商业信誉线索',
    inputSchema: {
      type: 'object',
      properties: {
