...
Agent 做成一个只会输出总结的搜索框，而是把它做成一个会分工的尽调班子：
有人盯来源，有人拆股权，有人看资本，有人查异常，有人负责把证据讲明白。

普通工具给你一段“看起来像结论”的话；这里给你一套能接着干的班子、底稿和路线图。
