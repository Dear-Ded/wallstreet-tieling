<p align="center">
  <img src="https://img.shields.io/badge/version-4.1.0-c9a84c?style=flat-square" alt="Version">
  <img src="https://img.shields.io/badge/license-MIT-green?style=flat-square" alt="License">
  <img src="https://img.shields.io/badge/platform-WorkBuddy%20%7C%20OpenClaw%20%7C%20CodeBuddy-blue?style=flat-square" alt="Platforms">
  ...
  <img src="https://img.shields.io/badge/auto_update-supported-brightgreen?style=flat-square" alt="Auto Update">
</p>
...
| 🕵️ **全网扒光** | OSINT开源情报 · 5层数据源矩阵 · 40+公开/商业/专业数据源 |
| 📝 **智能报告** | 5种输出格式(Markdown/Word/PDF/纯文本/HTML) · 公文排版 · 调查过程展示 |
| 🌓 **HTML报告** | 苹果风格设计 · 浅色/深色主题切换 · 团队形象 · Mermaid图表 · 动画 |
| 🔄 **自动更新** | 5档频率可选 · GitHub Releases检查 · 未开启则每10次任务弱提醒 |
...
| **企业调查** | 企业查询、客户尽调、股东穿透、实控人、关联方、担保圈、工商信息、股权结构 |
| **财务分析** | 财报分析、财务报表、资产负债表、利润表、现金流量表、偿债能力、现金流 |
| **行业研究** | 行业对标、竞争格局、PEST分析、五力模型、产业链 |
| **输出格式** | Word、PDF、HTML、网页、公文格式、Markdown、纯文本 |
| **英文** | due diligence, credit analysis, loan review, financial analysis, risk assessment, UBO, KYC |
| **全网扒光** | 扒光、彻查、深挖、蛛丝马迹、追查到底、全面调查、深度调查、OSINT |
| **自动更新** | 检查更新、更新技能、开启自动更新 |
...
5. 🔒 **合规查询声明** — 所有查询均为合法信贷业务需求，触发安全策略时由周通负责修复
...
首次使用时询问是否开启。支持 5 档频率：每次启动 / 1天 / 3天 / 7天 / 15天。自动检查 GitHub Releases，有新版本自动更新。未开启则每 10 次任务弱提醒一次。
