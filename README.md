...
[🌐 在线体验](https://dear-ded.github.io/wallstreet-tieling/) · [📖 完整文档](SKILL.md) · [💬 反馈建议](https://github.com/Dear-Ded/wallstreet-tieling/issues) · [⭐️ Star](https://github.com/Dear-Ded/wallstreet-tieling)
...
<!-- TODO: 添加截图或 GIF 演示 -->
<!-- 建议：使用 imgur 或 raw.githubusercontent.com 托管演示截图 -->
<!-- 待截图就位后删除此占位 -->
...
| **Phase 2: 交叉验证** | 郑慎之数据审计、吴德厚质量扫描、赵刚风险评估 | 校验报告 + 风险雷达 |
...
> 全量 No Fabrication 六层防御体系见 [`api/wst.py`](api/wst.py) 中 `NO_FABRICATION_RULE` 常量
...
| 平台 | 支持状态 | 推荐模式 |
|:-----|:---------|:---------|
| WorkBuddy | ✅ 完全支持 | 代码辅助模式 + MCP直达 |
| ChatGPT | ✅ 完全支持 | 代码辅助模式 |
| Claude | ✅ 完全支持 | 代码辅助模式 |
| 豆包 | ✅ 完全支持 | 纯文本+联网模式 |
| 通义千问 | ✅ 完全支持 | 代码辅助模式 |
| 文心一言 | ✅ 完全支持 | 纯文本+联网模式 |
| 小米MiMo | ✅ 完全支持 | 代码辅助模式，Token Plan 定价$0.435/M |
| DeepSeek | ✅ 完全支持 | API接入，1M上下文，90%缓存折扣 |
...
```
wallstreet-tieling/
├── SKILL.md                    # 主入口（Skill 定义 + 触发词）
├── api/
│   ├── wst.py                  # 动态编排器（3-Phase 尽调）
│   └── unified_supervisor.py   # 统一监督（政委 + 暗哨）
├── sub-skills/                 # 13 个专家角色
...
│   └── multi-platform-guide.md # 多平台部署指南
├── index.html                  # GitHub Pages 在线体验
├── CONTRIBUTING.md             # 贡献指南
├── CHANGELOG.md                # 变更日志
├── LICENSE                     # MIT 许可
└── references/
    ├── compatibility.md        # 平台兼容性
    ├── data-sources.md         # 数据源清单
    └── data-protocol.md        # 数据协议
```
