...
// Claude Desktop: claude_desktop_config.json
{
  "mcpServers": {
    "wallstreet-tieling": {
      "command": "npx",
      "args": ["-y", "@anthropic/mcp-server-prompt", "--skill", "https://raw.githubusercontent.com/Dear-Ded/wallstreet-tieling/main/SKILL.md"]
    }
  }
}
...
- `due_diligence("ABC公司", depth="standard")`
- `people_investigation("张三", phone="13812345678")`
- `financial_analysis("ABC公司", years=3)`
