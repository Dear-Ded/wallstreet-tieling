#!/usr/bin/env python3
"""wallstreet-tieling v4.0 — 组织记忆系统
五层本地存储: investigations/patterns/agents/chemistry/tools
全本地，零上传，用户可随时删除重置。
"""
...
def _memory_root() -> Path:
    home = Path.home() / ".workbuddy" / "wallstreet-tieling" / "memory"
...
class OrgMemory:
    ...
    def record(self, result: dict) -> dict:
        ...
        slug = result.get("target", "unknown").replace("/", "-")[:50]
