...
SHARED_TOOLS = [
    ...
    },
    {
        ...
        "purpose": "Read the one-packet desktop-agent start surface with host rows, gates, and field preservation rules.",
        "mcp_tool": "agent_delivery_packet",
        "cli": "npx wallstreet-tieling --agent-delivery",
        "api": "GET /api/agent-delivery",
        "required_output_fields": [
            "type",
            "release_target",
            "release_candidate",
    ...
    },
    {
        ...
        "purpose": "Run an install/post-package self-check for desktop-agent alpha readiness and final-product scope boundaries.",
        "mcp_tool": "agent_delivery_doctor",
        "cli": "npx wallstreet-tieling --agent-doctor",
        "api": "GET /api/agent-doctor",
        "required_output_fields": [
            "type",
            "status",
            "release_candidate",
            "checks.release_decision.full_product_status",
            "checks.agent_delivery_packet",
            "checks.package_files",
            "checks.commands",
            "scope_policy.must_not_shrink_final_product",
        ],
    },
    {
        "name": "report_delivery_targets",
        "purpose": "Read the required report-output contract for JSON, Markdown, portable HTML, DOCX, directory bundles, and persona interaction.",
        "mcp_tool": "report_delivery_targets",
        "cli": "npx wallstreet-tieling --report-targets",
        "api": "GET /api/report-targets",
        "required_output_fields": [
            "type",
    ...
    },
    {
        ...
        "purpose": "Check deep-mode source configuration, authorized-source readiness, fallback policy, and no-mid-run-prompt contract before investigation.",
        "mcp_tool": "source_preflight",
        "cli": "npx wallstreet-tieling --source-preflight",
        "api": "GET /api/source-preflight",
        "required_output_fields": [
            "type",
            "status",
            "deep_mode_status",
            "no_prompt_contract.subject_name_only_after_preconfiguration",
            "no_prompt_contract.stop_on_missing_advanced_source",
            "summary.ready_to_run",
            "summary.default_public_ready",
            "summary.configured_authorized_ready",
            "lanes",
            "next_actions",
        ],
    },
    ...
    },
    {
        ...
        "purpose": "Verify exported report bundle file hashes, manifest rows, and agent-handoff routing schema before sharing or archiving outputs.",
        "mcp_tool": "verify_report_bundle",
        "cli": "npx wallstreet-tieling --verify-report-bundle \"<export_dir>\"",
        "api": "GET/POST /api/verify-report-bundle",
        "required_output_fields": [
            "type",
            "ok",
            "checked_count",
